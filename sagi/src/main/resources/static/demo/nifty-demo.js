...
$(document).on('nifty.ready', function () {
    ...
    // SETTINGS WINDOW
    // =================================================================
    var contentIndi = '<div id="demo-settings-load" class="demo-settings-load"><i class="text-main demo-pli-repeat-2 icon-3x fa-spin"></i><br><h4 id="demo-get-statusEquipamento" class="text-bold text-uppercase">Loading...</h4><p id="demo-get-statusEquipamento-text">Please wait while the content is loaded</p></div>';
    ...
    $('#demo-set-btn').one('click', function(){
        ...
        $.get("settings.html", function( data ) {
            ...
            $("#demo-get-statusEquipamento").html(e.status);
            $("#demo-get-statusEquipamento-text").html(e.statusText);
        });
    });
